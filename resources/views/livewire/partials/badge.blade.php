        ...
        <div style="display: grid; grid-template-columns: 380px 1fr; gap: 22px; align-items: start;"
            ...
            <div style="background: #16181D; border-radius: 18px; padding: 24px; color: #fff;">
                ...
                @if(! $bdone)
                    ...
                    <button type="button" x-show="file" x-cloak @click="analyze()" :disabled="busy" style="width: 100%; margin-top: 18px; padding: 14px; border: none; border-radius: 12px; background: #E85D2A; color: #fff; font-size: 15px; font-weight: 600; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 9px;">
